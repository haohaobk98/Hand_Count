...
namespace HandGestureRecognition
{
    public partial class Form1 : Form
    {
        ...
        Rectangle handRect; // biến để hiển thị khung
        MCvBox2D box; // biến  khởi tạo 1 khung (hình chữ nhật)
        Ellipse ellip; // biến khởi tạo 1 ellip
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            {
                currentFrameCopy = currentFrame.Copy(); // có được khung ánh xạ của bàn tay(khung trắng đen)
        ...
        {            
            {
                ...
                if (biggestContour != null)
                {
                    ...
                    /* hiển thị toàn bộ khung chưa bàn tay khi sử dụng 2 câu lệnh sau
                    ...
                    PointF center;
                    float radius;
                    #region vẽ ellip giới hạn
                    // vẽ đường ellip giới hạn bao quanh khi sử dụng những câu lệnh dưới đây (2 câu lệnh sẽ ra 1 màu khác nhau)
